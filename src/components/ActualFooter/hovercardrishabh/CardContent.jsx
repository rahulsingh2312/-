  ...
  return (
    <div className="relative flex flex-col px-8 py-1 w-full bg-blend-exclusion rounded-[30px] text-white">
      ...
      <div className='flex mt-2 justify-between'>
          <h2 className="text-transparent my-2 bg-clip-text bg-gradient-to-b from-white to-[#ffffff66]">Dev & Des</h2>
    <a className='z-[99999]' target='_blank' href='https://x.com/rizz_abh'>  <img 
        loading="lazy" 
      ...
      {/* <a target='_blank' href='https://rahulol.me'><div className="relative mt-5 md:mt-16 mb-3 text-3xl left-0 mr-20">rahulol.me</div></a> */}

      <a target='_blank' href='https://rizzabh.xyz'><div className="relative mt-5 md:mt-16 mb-3 text-3xl left-0 mr-20">rizzabh.xyz</div></a>
    </div>
  );
}
