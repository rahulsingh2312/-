  ...
  return (
    <div className="relative flex flex-col px-8 py-1 w-full bg-blend-exclusion rounded-[30px] text-white">
      ...
      <div className='flex mt-2 justify-between'>
          <h2 className="text-transparent my-2 bg-clip-text bg-gradient-to-b from-white to-[#ffffff66]">Web3 Dev</h2>
    <a className='z-[99999]' target='_blank' href='https://x.com/rrahulol'>  <img 
        loading="lazy" 
