...
function CardContent() {
  return (
    <div className="relative flex flex-col px-8 py-1 w-full min-h-[4px] bg-blend-exclusion rounded-[30px] text-white">
      <img 
        loading="lazy" 
      ...
      <div className="relative mt-16 mb-3 text-3xl left-0 mr-20">rahulol.me</div>
    </div>
  );
}
